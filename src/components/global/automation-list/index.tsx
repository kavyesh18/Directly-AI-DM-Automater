...
const AutomationList = (props: Props) => {
  ...
  return <div className='flex flex-col gap-y-3'>
    <Link href={`${pathname}/123458589494`} className='bg-[#1D1D1D] hover:opacity-80 transition duration-100 rounded-xl p-5 border-[1px] radial--gradient--automations flex border-[#545454]'>
    <div className='flex flex-col flex-1 items-start'>
        <h2 className='text-xl font0-semibold'>
            Automation Name
        </h2>
    ...
    <p className='capitalize text-sm font-light text-[#9B9AC0]'>
