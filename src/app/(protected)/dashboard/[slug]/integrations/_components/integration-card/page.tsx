...
const IntegrationCard = ({title, description, icon, strategy}: Props) => {
    //WIP: Wire up fetching data and get the prefetch automations from the database

  return <div className='border-2 border-[#3352CC] rounded-2xl gap-x-5 p-5 flex items-center justify-between'>
    {icon}
